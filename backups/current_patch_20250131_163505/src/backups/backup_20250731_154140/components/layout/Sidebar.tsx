...
import { ChevronRight, Home, Folder, Users, Settings, HardDrive, Bell, Search } from 'lucide-react';
...
export function Sidebar({ activePage, onPageChange, address, isCollapsed = false, onToggleCollapse }: SidebarProps) {
  ...
  const storagePercentage = storageInfo ? (storageInfo.used / storageInfo.total) * 100 : 0;
        ...
        <div className="flex items-center justify-around py-3">
          ...
          >
           ...
           <button
             ...
             className="p-3 rounded-md transition-colors text-gray-300 hover:bg-gray-800 hover:text-white"
          ...
          <button
            ...
            className="p-3 rounded-md transition-colors text-gray-300 hover:bg-gray-800 hover:text-white bg-gray-800/70 border border-gray-700/50"
   ...
   return (
           <div 
        className="fixed left-0 top-0 w-[280px] bg-[#1A1A1A] min-h-screen flex flex-col border-r border-gray-800 z-40"
      >
