...
import { Search, User, Users, Eye, EyeOff, FileText, Calendar } from 'lucide-react';
...
export function ProfileSearch({ isOpen, onClose, currentAddress }: ProfileSearchProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-black/80 backdrop-blur-xl border border-white/10 rounded-2xl p-6 w-full max-w-2xl">
        {/* Header */}
