-- ========================================
-- COMPLETE IRYSHARE DATABASE SCHEMA
-- Clean, well-designed structure for file sharing without duplicates
-- ========================================

-- ========================================
-- 1. DROP EXISTING TABLES (KEEP USERNAMES)
-- ========================================

-- Drop existing tables (keeping usernames)
DROP TABLE IF EXISTS public.files CASCADE;
DROP TABLE IF EXISTS public.file_shares_new CASCADE;
...
-- Insert existing user storage data
INSERT INTO public.user_storage (address, used_bytes, total_bytes, last_updated, created_at)
SELECT 
    user_address,
    used_bytes,
    total_bytes,
...
-- Drop old tables after migration (uncomment when ready)
-- DROP TABLE IF EXISTS public.user_storage_old CASCADE; 