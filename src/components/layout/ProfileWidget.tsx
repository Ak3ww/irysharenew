...
export function ProfileWidget({ address, isConnected, usernameSaved }: ProfileWidgetProps) {
  ...
  useEffect(() => {
    const handleStorageChange = (event: Event) => {
      console.log('🔄 ProfileWidget: Storage change event received:', event.type);
      if (event.type === 'file-uploaded') {
        const customEvent = event as CustomEvent;
        console.log('📁 File uploaded event details:', customEvent.detail);
      }
      fetchStats();
    };
    ...
    console.log('👂 ProfileWidget: Event listeners attached for storage updates');
    ...
    return () => {
      ...
      console.log('👂 ProfileWidget: Event listeners removed');
    };
  }, []);
          ...
          <div className="p-6">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 p-3 bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/30 rounded-lg text-blue-400 transition-colors"
